...
class WinkCommand extends Command_1.ICommand {
    constructor() {
    ...
    execute(user, interaction, args) {
        return __awaiter(this, void 0, void 0, function* () {
            let winkFetch = { link: "" };
            try {
                winkFetch = yield (yield (0, node_fetch_1.default)(ImageManager_1.default.getInstance().getImage('wink').url)).json();
            }
            catch (e) {
...
exports.default = WinkCommand;
//# sourceMappingURL=WinkCommand.js.map